...
from adapters.typescript_adapter import compile_contract, prove_contract
...
class TypeScriptAdapterTests(unittest.TestCase):
    ...
    def test_compile_and_prove(self):
        ...
        self.assertIn("Number.isSafeInteger", artifact.source)
        ...
        self.assertIn("numeric correctness depends on the declared safe-integer domain and JavaScript runtime semantics", outcome.dissent)
