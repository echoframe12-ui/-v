...
def test_production_smoke_exercises_readiness_and_status_endpoint(tmp_path, monkeypatch):
    ...
    assert result.checks == {"db": True, "workspace": True, "status_endpoint": True}
