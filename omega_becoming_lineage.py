...
def advance_with_lineage(observation: Observation, *, attestation_id: str, parent_attestation_id: str | None = None, lineage_depth: int = 0) -> BecomingLineage:
    if lineage_depth < 0:
    ...
    return BecomingLineage(transition, attestation_id, parent_attestation_id, lineage_depth)


def to_dict(lineage: BecomingLineage) -> dict[str, Any]:
    return {"attestation_id": lineage.attestation_id, "parent_attestation_id": lineage.parent_attestation_id, "lineage_depth": lineage.lineage_depth, "transition": ContinuousBecomingEngine.to_dict(lineage.transition)}
