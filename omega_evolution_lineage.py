...
def propose_with_lineage(
    ...
    *,
    ...
    """Project the canonical evolution proposal without mutating history."""
...
def to_dict(lineage: EvolutionLineage) -> dict[str, Any]:
    return {
        ...
        "proposal": lineage.proposal.to_dict() if lineage.proposal else None,
    }
