...
def verify_live() -> VerificationResult:
    """Exercise the complete contract + application E2E path and feed it into MOOD."""
    from app import app, service
    from final_e2e import verify as verify_e2e

    # The contract gate is the first boundary: all Ω∞v layers must import cleanly
    # and the Edge verifier must reject an empty attestation.
